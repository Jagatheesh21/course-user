  ...
  <!--About One Start-->
                            ...
                            <ul class="about-one__left-img-box list-unstyled clearfix">
                                <li class="about-one__left-single">
                                    <div class="about-one__left-img1">
                                        <img src="{{asset('assets/images/about/pro.jpeg')}}" alt="" />
                                    </div>
                                </li>
                    ...
                    <div class="col-xl-6">
                        <div class="about-one__right">
                            <div class="section-title">
                                ...
                                <h2 class="section-title__title">One Stop Solution For Your Career Growth</h2>
                            </div>

                            <div class="search-popup__content my-3">
                                    <form action="#">

                                        <input style="border:1px solid blue;border-radius: 20px;" type="text" id="search" placeholder="Search From 150+ Expert Made Courses" />
                                        <button style="border-radius: 0px 20px 20px 0px; " type="submit" aria-label="search submit" class="thm-btn2">
                            ...
                            <div class="about-one__right-inner">
                                <p class="about-one__right-text">There are many variations of passages of lorem ipsum.</p>
        ...
        <section class="mb-3">
            <div class="container-fluid">
                <div class="row">
                    <h5 class="mb-4 text-center">Our Programs Created in Collaboration with Top MNCs & Universities</h5>
                    <div class="col-md-12">
                        <div class="customer-logos">
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/06-Nasscom.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/07-IBM.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/08-Microsoft.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/07/IIT-Madras-logo.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/11-ISC2.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/09-IIBA.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/12-CompTIA.png"></div>
                          <div class="slide"><img width="118" height="48" src="https://intellipaat.com/course-image/2021/06/05-JAIN-Online.png"></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <a href="{{route('course-detail',['course' => $course->slug])}}">
                        <div class="courses-one__single wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms" >
                            ...
                            <div class="courses-one__single-content" style="height:260px !important">
                                <div class="courses-one__single-content-overlay-img">
                                    <img src="{{asset('assets/images/resources/coding.jpeg')}}" alt="" />
                                </div>
                                <h6 class="courses-one__single-content-name">{{$course->author->name}}</h6>
                                ...
                                <p class="courses-one__single-content-price"><span>$</span>{{$slot->slots()->first()?number_format($slot->slots()->first()->price,2):0.00}}</p>
                                <ul class="courses-one__single-content-courses-info list-unstyled">
                                    <li>{{$course->modules_count}} Modules</li>
                                    <li>{{$module->sections?$module->sections->first()->duration:""}}</li>
                                    <li>{{$slot->skill_level?$slot->skill_level->name:""}}</li>
                                </ul>
                            </div>
                        </div>
                    </a>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6">
                        <div class="courses-one__single wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1000ms">
                            <div class="courses-one__single-img">
                                <img src="assets/images/resources/coding.jpg" alt="" />
                                <div class="overlay-text">
                                    <p>Featured</p>
                                </div>
                            </div>
                            <div class="courses-one__single-content">
                                <div class="courses-one__single-content-overlay-img">
                                    <img src="assets/images/resources/coding.jpeg" alt="" />
                                </div>
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="why-choose-one__right wow slideInRight animated clearfix" data-wow-delay="0ms"
                            ...
                            <div class="why-choose-one__right-img clearfix">
                                <img width="600px" height="600px" src="assets/images/resources/why.jpg" alt="" />
